...
import (
	...
	"github.com/Brian-Mashavakure/capstone_backend_service/pkg/images-apis/images-middleware"
...
func ImageRoutes(router *gin.Engine) {
	...
	api.POST("/postimage", images_middleware.UrlRefreshMiddleware, images_handlers.PostImageHandler)
